...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        self.font = pygame.font.Font(join(self.base_path, 'font', 'LycheeSoda.ttf'), 30)
        ...
        #movement
        self.index = 3               #chooses where border goes
    ...
    def setup(self):
        ...
        self.buy_text = self.font.render('buy', False, 'dark green')
        self.sell_text = self.font.render('sell', False, 'dark green')
    ...
    def show_entry(self, text_surf, amount, top, selected):
        ...
        #amount
        amount_surf = self.font.render(str(amount), False, 'dark green')        #pygame does not render integers
